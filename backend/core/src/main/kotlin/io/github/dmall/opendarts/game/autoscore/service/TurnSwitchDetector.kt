...
private const val EMPTY_FRAMES_THRESHOLD = 5 * FPS
...
class TurnSwitchDetector {
  ...
  fun resetStateForNewTurn(playerId: String, sessionId: String, detectionState: DetectionState) {
  ...
  fun checkMaximumDartsReached(confirmedDartsCount: Int, detectionState: DetectionState): Boolean {
