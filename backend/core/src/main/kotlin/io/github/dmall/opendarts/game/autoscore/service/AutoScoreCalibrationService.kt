...
constructor(applicationEventPublisher: ApplicationEventPublisher) :
    ...
    return calibrationState.calibrationList.all { prevCalibration ->
      newPoints.all { newPoint ->
        ...
        if (prevCalibrationPoint != null) {
          ...
          val distance = calculateDistance(prevCalibrationPoint, Pair(newPoint.x, newPoint.y))
  ...
  private fun isMissingCalibrationPoint(x: Double, y: Double): Boolean = x == -1.0 && y == -1.0
}
