...
abstract class AutoScoreBaseService(
  ...
  protected fun composeId(playerId: String, sessionId: String): String = "$playerId/$sessionId"

  protected fun calculateDistance(pos1: Pair<Double, Double>, pos2: Pair<Double, Double>): Double {
