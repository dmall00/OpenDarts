...
class TurnSwitchDetectedEvent(source: Any, sessionId: String, playerId: String) :
  GameEvent(source, sessionId, playerId, EventType.TURN_SWITCH_DETECTED)

class CalibrationEvent(source: Any, sessionId: String, playerId: String, val calibrated: Boolean) :
