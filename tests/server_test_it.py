...
from autoscore.model.request import RequestType, ScoringRequest, CalibrationRequest, PingRequest
from autoscore.model.response import BaseResponse, Status, PingResponse, CalibrationResponse, ScoringResponse
...
@pytest.mark.asyncio
async def test_websocket_integration(websocket_server) -> None:
